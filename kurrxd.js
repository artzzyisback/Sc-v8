...
const nyoutube = ('©DimzHost')  //ubah di config biar ngk emr
//━━━━━━━━━━━━━━━[ DIWNLOAD YTMP3 ]━━━━━━━━━━━━━━━━━//
...
const reply = (teks) => {
kurrxd.sendMessage(m.chat, { text: teks ,
contextInfo:{
...
switch (command){
    ...
    kurrxd.sendMessage(
        ...
        const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `https://s.id/DimzHost`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;DimzHost Assistant,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/3e08ed0902b6a593f4b00.jpg' }}}}
...
case "pushmember":
          {
            if (!isCreator) throw m.reply(mess.OnlyOwner)
            if (!text) throw m.reply(`Menu ini hanya akan mengirim broadcast ke grup.\n\nContoh: ${prefix + command} dun ga bang? dunnn`)
...
case 'pushjeda' : {
          ...
          for (let i = 0; i < get.length; i++) {
            setTimeout(function() {
              ...
              sentCount++;
              if (count === 0) {
                m.reply(`*_Succes Push Kontak Sayangku:_*\n*_Jumlah Pesan Terkirim: ${sentCount}_*`);
              }
            }, i * delayy);
          }
        }
        ...
        case 'pushid' : {
          ...
          let metaDATA = await kurrxd.groupMetadata(idgc).catch((e) => {m.reply(e)})
...
case 'listseler':{
if (!isCreator) return m.reply(`sorry anda sepertinya bukan pemilik bot`)
let listusr =`*List user Resler Panel DimzHost*\n\ntotal user : ${owner.length}\n`
var no = 1
for (let x of owner) {
listusr +=`\nUser: ${no++}\nID: ${x}\n\n`
}
...
//=================================================//
case 'ping': {
kurrxd.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3e08ed0902b6a593f4b00.jpg' }, caption: `command : ${prefix}
...
case 'req': case 'request': {
               ...
               let ownernya = '6285142317870@s.whatsapp.net'
               let me = m.sender
            ...
            await kurrxd.sendButtonText(m.chat, akhji, nyoutube, m, {mentions: ments, quoted: m })
            }
            break  
        //hentai 18+
case 'sewa': 
...
break
case 'dellist':{
    if (!isCreator) return m.reply(`di grup bang`)
...
*Link* : https://youtube.com/@DimzHost`},
{quoted: m})
        break
    case 'gc':
    case 'group':
	kurrxd.sendMessage(from, 
{text: `*Group DimzHost*\n
Group DimzHost : https://chat.whatsapp.com/p
Griup ChinoBotz : https://chat.whatsapp.com/p`},
{quoted: m})
        break
case 'hapuslist':
...
//fitur menfess// main menu
        case 'menfess':
			...
			//	 var button = [{ buttonId: `menfesconfirm`, buttonText: { displayText: `CONFIRM‡` }, type: 1 }, { buttonId: `sewabot`, buttonText: { displayText: `SEWABOT‡` }, type: 1 }]
					kurrxd.sendMessage(`${nomor}@s.whatsapp.net`, { caption: teksnya, image: {url: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMkjAJhYezm4h6k1AJ6qfreGkaRdBcR7UHMw&usqp=CAU`}, footer: `DimzHost\nhttps://s.id/DimzHost` })
       ...
       break
            ...
            await kurrxd.sendButtonText(m.chat, akhji, nyoutube, m, {mentions: ments})
            }
        break
       ///top up
case 'script': case 'sc':{
...
// INI FITUR STORE GAME YA JING //
        case 'yts': case 'ytsearch': {
                ...
                kurrxd.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: m })
            }
        break
case 'emojimix': {
...
var opt = { packname: "©Sticker By", author: "DimzHost Assistant" }
...
kurrxd.sendMessage(from, {text : asu}, {quoted : m})
      ...
      case 'group' : {
        ...
        if (!isAdmins) return m.reply(mess.OnlyAdmin)
        if (text === 'close') {
     ...
     //     ]
        //  await kurrxd.sendButtonText(m.chat, 'Group Mode', packname, m)
     //   }
      }
        break
           case 'addgc':
...
case 'panel1':
case 'panelku':{
let teq =`_• *Panel Hosting Bot By DimzHost*_
...
case 'don':{
if (!isGroup) return m.reply(mess.OnlyGroup)         
if (!isCreator && fromMe) return m.reply(mess.OnlyOwner)
let tek = (`「 *TRANSAKSI BERHASIL* 」\n\n\`\`\`📆 TANGGAL : ${tanggal}\n⌚ JAM     : ${jam}\n✨ STATUS  : Berhasil\`\`\`\n\nTerimakasih Telah order di *DimzHost*\nNext Order ya🙏`)
//let btn_menu = [
...
case 'donasi': case 'donate': case 'donasi': case 'donasi': {
                kurrxd.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/de06b6e32db617a273376.jpg' }, caption: `*Hi Bro ${m.pushName}*\n*_Jika ingin Donasi Silahkan Scan Gambar Diatas_*
...
let depo = `Hai *@${sender.split('@')[0]}*\nBerikut List Payment Dari DimzHost
*- ${prefix}dana*
*- ${prefix}gopay*
*- ${prefix}ovo*
*- ${prefix}qris*`
...
let tampilan_nya = `List Sewa Bot By DimzHost
Keuntungan?
- Bebas Spam
...
BERIKUT ADALAH LIST HARGA SEWA BOT DI DimzHost
...
case 'panelmenu':
        m.reply(`proses`)
        kurrxd.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3e08ed0902b6a593f4b00.jpg' }, caption:`
– *Panel Menu*
...
┗━━━━━━━━━━━━━━━━━━━`);
        ...
        break
case 'domain10': {
    if (!jangan) return m.reply("maaf grup ini blom di add oleh DimzHost")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
...
┗━━━━━━━━━━━━━━━━━━━`);
        ...
        break
case 'domain16': {
    if (!isGroup) return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
...
┗━━━━━━━━━━━━━━━━━━━`);
    ...
    if (!jangan) return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
           ...
           let raw1 = args?.join(" ")?.trim();
           if (!raw1) return m.reply("PENGGUNAAN .domain22 hostname|167.29.379.23");
           let host1 = raw1
             .split("|")[0]
             .trim()
             .replace(/[^a-z0-9.-]/gi, "");
...
🖥️LOGIN: ${domain}
`
    await kurrxd.sendMessage(m.chat, {text : tks})
...
case 'sticker': case 's': case 'stickergif': case 'sgif': {
        ...
        break
case 'qris': {
kurrxd.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/de06b6e32db617a273376.jpg' }, caption: `JAN LUPA SS BUKTI YAH | example : .bukti` }, { quoted: m })
} 
        break
case 'dana': {
kurrxd.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/de06b6e32db617a273376.jpg' }, caption: `JAN LUPA SS BUKTI YAHA example : .bukti` }, { quoted: m })
}
        break
case 'gopay': {
kurrxd.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/de06b6e32db617a273376.jpg' }, caption: `JAN LUPA SS BUKTI YAHA example : .bukti` }, { quoted: m })
...
if (!isCreator) return m.reply('Lu Bukan DimzHost Asu')
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
...
break
        ...
        case "1gb": {
if (!isSeler) return m.reply(`Emang lu udah join reseller di DimzHost? kalau belum gausah pake fitur ini blok`)
let t = text.split(',');
if (t.length < 2) return m.reply(`*Format salah!*
Penggunaan:
${prefix + command} user,nomer`)
