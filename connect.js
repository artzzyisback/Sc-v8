//PAIRING RAFATHAR OFFCIAL DILARANG SEBARR
//TAR GUA SERAHIN KE LU MOHON JANGAN SEBAR FREE KE TEMAN LU/SIAPA GUA BIKIN 3HARI LEBI BLOM JADI INI BARU JADI JADI🙏🙏🙏JANGAN SEBAR TAR
...
CFonts.say("SC PAIRING BY JarzTzy", {
   font: 'chrome',
  align: 'left',
  gradient: ['red', 'magenta'],
});
CFonts.say(
  "Sc Bot By Jarz\nBase: Ori Jarz\nRecodeBy:Jarz\ncampuranv:8\nRuning:Panel\n\n\nSc Ini Di Recode JarzTzy Kalo Kethauan Jual Murah Sc inI gua Banned Nyawa Lu Jarak Jauh\n\n\n",
  {
    colors: ["system"],
    font: "console",
    align: "center",
...
//await sleep(400) 
console.log(`${color(`[`,`white`)+color(`3`,`red`)+color(`]`,`white`)}`,`Base Sc:J a r z`)
//await sleep(400)  
console.log(`${color(`[`,`white`)+color(`4`,`red`)+color(`]`,`white`)}`,"date 5") 
//await sleep(400)  
console.log(color(`─[`,`magenta`),`「`,  color(`JarzOfficial`,`red`), `」`,  color(`]─`,`magenta`))
//await sleep(400)  
start(`1`,`Connecting...`)
